/* uni-data.js — trích nguyên văn UNI_DATA từ mobile mobile/university/matches/index.html */
var UNI_DATA = [
  ...
  { id:'liberty',  icon:'LU', name:'Liberty University',
    loc:'Lynchburg, VA, USA', country:'USA', type:'priv', typeLabel:'Private',
    match:86, ranking:'National University (US)', students:'135,000+', employment:'91%',
    tuition:'$24,000 / yr', aid:'Merit + Need Aid', aidType:'merit',
    salary:'$4,100 / mo avg', programs:['Business','Computer Science','Aviation','Education','Health Sciences'],
    partner:true },

  { id:'mru',      icon:'MRU', name:'Miami Regional University',
    loc:'Miami Springs, FL, USA', country:'USA', type:'priv', typeLabel:'Private',
    match:78, ranking:'Healthcare-focused University', students:'1,200+', employment:'92%',
    tuition:'$18,000 / yr', aid:'Merit-Based Aid', aidType:'merit',
    salary:'$3,700 / mo avg', programs:['Nursing','Healthcare Management','Business','Education'],
    partner:true },

  { id:'mau',      icon:'MAU', name:'Millennia Atlantic University',
    loc:'Doral, FL, USA', country:'USA', type:'priv', typeLabel:'Private',
    match:74, ranking:'Business-focused University', students:'600+', employment:'91%',
    tuition:'$12,000 / yr', aid:'Merit-Based Aid', aidType:'merit',
    salary:'$3,600 / mo avg', programs:['Business Administration','International Business','Marketing','Management'],
    partner:true },

  { id:'imt',      icon:'IMT', name:'IMT Atlantique',
    loc:'Brest / Nantes / Rennes, France', country:'France', type:'pub', typeLabel:'Graduate Engineering',
    match:83, ranking:'Top French Engineering School', students:'2,300+', employment:'98%',
    tuition:'EUR 4k / yr (~$4.4k)', aid:'Merit Scholarship', aidType:'merit',
    salary:'$4,900 / mo avg', programs:['Engineering','Computer Science','Telecommunications','Energy','Data Science'],
    partner:true },
